...
const parsedResponse = [
  {
    attribute: 'item_name',
    proposed:
      'Generic Engraved Metal Keychain - Durable Personalized Keyring for Everyday Use',
  },
  {
    attribute: 'bullet_point',
    proposed:
      'Keep your keys organized and add a personal touch with our Engraved Metal Keychain, perfect for everyday use.',
  },
  {
    attribute: 'bullet_point',
    proposed:
      'Personalize this durable metal keyring with a name, initials, or a special date to create a unique and memorable accessory.',
  },
  {
    attribute: 'bullet_point',
    proposed:
      "Enjoy a compact design that ensures it won't add unnecessary bulk to your pockets or bags.",
  },
  {
    attribute: 'bullet_point',
    proposed:
      'Rely on the sturdy metal construction to ensure your keys stay secure at all times.',
  },
  {
    attribute: 'bullet_point',
    proposed:
      'Give a thoughtful gift or treat yourself with this keychain that combines practical utility with sentimental value.',
  },
  {
    attribute: 'product_description',
    proposed:
      "Keep your keys organized and add a personal touch with our Engraved Metal Keychain. Crafted from durable metal, this keyring is perfect for everyday use. Personalize it with a name, initials, or a special date to create a unique and memorable accessory. Ideal for gifts or to treat yourself, this keychain combines practical utility with sentimental value. Its compact design ensures it won't add bulk to your pockets, while its sturdy construction ensures your keys stay secure.",
  },
  {
