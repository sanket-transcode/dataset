...
const parsedResponse = {
  ...
  item_name: [
    {
      value: 'Engraved Metal Keychain, Small Floral Wrist Keychain',
    },
  ],
  team_name: [],
  department: [
  ...
  bullet_point: [
    {
      value:
        'Keep your keys organized and add a personal touch with our Engraved Metal Keychain.',
    },
    {
      value:
        'Crafted from durable metal, this keyring is perfect for everyday use.',
    },
    {
      value:
    ...
    {
      value:
        "Its compact design ensures it won't add bulk to your pockets, while its sturdy construction ensures your keys stay secure.",
    },
  ],
  gift_options: [
    {
