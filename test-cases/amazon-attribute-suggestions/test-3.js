...
const parsedResponse = {
      ...
      properties: {
        classification: {
          items: {
            properties: {
              class: {
                value: 'amzn_specific_no_label_with_warning',
              },
            },
          },
        },
  ...
  item_name: {
    items: {
      properties: {
        value: "Embroidered Fabric Wristlet Keychain, Women's Floral Key Chain",
      },
    },
  },
  team_name: {
  ...
  model_name: {
    items: {
      properties: {
        value: 'Generic Wristlet Keychain',
      },
    },
  },
  skip_offer: {
  ...
  bullet_point: {
    items: {
      properties: {
        value:
          'Keep your keys organized and add a personal touch with our Engraved Metal Keychain. Crafted from durable metal, this keyring is perfect for everyday use. Personalize it with a name, initials, or a special date to create a unique and memorable accessory.',
      },
    },
  },
  gift_options: {
  ...
  safety_warning: {
    items: {
      properties: {
        value: 'Choking hazard: Small parts. Keep away from children.',
      },
    },
  },
  ships_globally: {
  ...
  generic_keyword: {
    items: {
      properties: {
        value:
          'keychain, wristlet, floral key chain, personalized gift, metal keyring',
      },
    },
  },
  item_dimensions: {
        ...
        automated_pricing_merchandising_rule_plan: {
          items: {
            properties: {
              merchandising_rule: {
                properties: {
                  rule_id: '794258218002-COMPETITIVE_BUYBOX',
                },
              },
            },
          },
  ...
  product_description: {
    items: {
      properties: {
        value:
          "Keep your keys organized and add a personal touch with our Engraved Metal Keychain. Crafted from durable metal, this keyring is perfect for everyday use. Personalize it with a name, initials, or a special date to create a unique and memorable accessory. Ideal for gifts or treating yourself, this keychain combines practical utility with sentimental value. Its compact design ensures it won't add bulk to your pockets, while its sturdy construction ensures your keys stay secure.",
      },
    },
  },
  customer_package_type: {
  ...
  supplemental_condition_information: {
    items: {
      properties: {
        cosmetic: 'no_sign_of_use',
        features: [],
        packaging: 'amazon',
        accessories: 'not_applicable',
        source_type: 'as_is',
        functional_condition: 'fully_functional',
        battery_life_percentage: 'no_battery',
      },
    },
  },
  supplier_declared_dg_hz_regulation: {
