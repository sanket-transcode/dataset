  ...
  (
    VALUES 
      (
        ...
        'en_US', 113421, 248 :: BIGINT, 2 :: BIGINT, 
        false :: BOOLEAN, 'https://m.media-amazon.com/images/I/41QhOymrgRL.jpg'
      ), 
      (
        7613, null :: BIGINT, 516 :: BIGINT, 1374 :: BIGINT, 
        'en_US', 113422, 248 :: BIGINT, 3 :: BIGINT, 
        false :: BOOLEAN, 'https://m.media-amazon.com/images/I/51pwV6zSR9L.jpg'
      ), 
      (
        7613, null :: BIGINT, 516 :: BIGINT, 1373 :: BIGINT, 
        'en_CA', 113421, 248 :: BIGINT, 2 :: BIGINT, 
        false :: BOOLEAN, 'https://m.media-amazon.com/images/I/41QhOymrgRL.jpg'
      ), 
      (
        7613, null :: BIGINT, 516 :: BIGINT, 1373 :: BIGINT, 
        'en_CA', 113422, 248 :: BIGINT, 3 :: BIGINT, 
        false :: BOOLEAN, 'https://m.media-amazon.com/images/I/51pwV6zSR9L.jpg'
      )
  ) AS incoming (
  ...
  (
    VALUES 
      (
        ...
        1374 :: BIGINT, 'en_US', 113421, 248 :: BIGINT, 
        2 :: BIGINT, false :: BOOLEAN, 'https://m.media-amazon.com/images/I/41QhOymrgRL.jpg'
      ), 
      (
        7613, null :: BIGINT, 516 :: BIGINT, 1374 :: BIGINT, 
        'en_US', 113421, 248 :: BIGINT, 2 :: BIGINT, 
      ...
      (
        7613, null :: BIGINT, null :: BIGINT, 
        1374 :: BIGINT, 'en_US', 113422, 248 :: BIGINT, 
        3 :: BIGINT, false :: BOOLEAN, 'https://m.media-amazon.com/images/I/51pwV6zSR9L.jpg'
      ), 
      (
        7613, null :: BIGINT, 516 :: BIGINT, 1374 :: BIGINT, 
        'en_US', 113422, 248 :: BIGINT, 3 :: BIGINT, 
      ...
      (
        7613, null :: BIGINT, null :: BIGINT, 
        1373 :: BIGINT, 'en_CA', 113421, 248 :: BIGINT, 
        2 :: BIGINT, false :: BOOLEAN, 'https://m.media-amazon.com/images/I/41QhOymrgRL.jpg'
      ), 
      (
        7613, null :: BIGINT, 516 :: BIGINT, 1373 :: BIGINT, 
      ...
      (
        7613, null :: BIGINT, null :: BIGINT, 
        1373 :: BIGINT, 'en_CA', 113422, 248 :: BIGINT, 
        3 :: BIGINT, false :: BOOLEAN, 'https://m.media-amazon.com/images/I/51pwV6zSR9L.jpg'
      ), 
      (
        7613, null :: BIGINT, 516 :: BIGINT, 1373 :: BIGINT, 
