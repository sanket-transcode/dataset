...
FROM 
  (
    VALUES 
      (
        7661, 26324 :: BIGINT, 516 :: BIGINT, 
        1374 :: BIGINT, 'en_US', 113402, 248 :: BIGINT, 
        1 :: BIGINT, true :: BOOLEAN, 'https://m.media-amazon.com/images/I/311cmBKQF+L.jpg'
      ), 
      (
        7661, 26324 :: BIGINT, 516 :: BIGINT, 
        1373 :: BIGINT, 'en_CA', 113402, 248 :: BIGINT, 
        1 :: BIGINT, true :: BOOLEAN, 'https://m.media-amazon.com/images/I/311cmBKQF+L.jpg'
      ), 
      (
        7661, 26325 :: BIGINT, 516 :: BIGINT, 
        1374 :: BIGINT, 'en_US', 113402, 248 :: BIGINT, 
        1 :: BIGINT, true :: BOOLEAN, 'https://m.media-amazon.com/images/I/311cmBKQF+L.jpg'
      ), 
      (
